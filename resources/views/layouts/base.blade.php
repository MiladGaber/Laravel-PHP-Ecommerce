...
<head>
    ...
    <link rel="apple-touch-icon" href="{{assets('assets/img/icon.png')}}">

    <!-- ************************* CSS Files ************************* -->

    <!-- Vendor CSS -->
    <link rel="stylesheet" href="{{assets('assets/css/vendor.css')}}">
...
<body>
                                    ...
                                    <div class="header__main-left">
                                        <div class="logo">
                                            <a href="index.html" class="logo--normal">
                                                <img src="{{assets('assets/img/logo/logo.png')}}" alt="Logo">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <ul class="mini-cart__list">
                            <li class="mini-cart__product">
                                ...
                                <div class="mini-cart__product-image">
                                    <img src="{{assets('assets/img/products/prod-01-100x100.jpg')}}" alt="products">
                                </div>
                            ...
                            <li class="mini-cart__product">
                                ...
                                <div class="mini-cart__product-image">
                                    <img src="{{assets('assets/img/products/prod-02-100x100.jpg')}}" alt="products">
                                </div>
                                <div class="mini-cart__product-content">
                                    <a class="mini-cart__product-title" href="product-details.html">Golden Easy Spot Chair.</a>
                                    <span class="mini-cart__product-quantity">1 x $49.00</span>
                            ...
                            <li class="mini-cart__product">
                                ...
                                <div class="mini-cart__product-image">
                                    <img src="{{assets('assets/img/products/prod-03-100x100.jpg')}}" alt="products">
                                </div>
                                <div class="mini-cart__product-content">
                                    <a class="mini-cart__product-title" href="product-details.html">Golden Easy Spot Chair.</a>
                                    <span class="mini-cart__product-quantity">1 x $49.00</span>
                        ...
                        >
                            <div class="product-image">
                                <div class="product-image--holder">
                                    <a href="product-details.html">
                                        <img src="{{assets('assets/img/products/prod-01.jpg')}}" alt="Product Image" class="primary-image">
                                    </a>
                                </div>
                            ...
                            <div class="product-image">
                                <div class="product-image--holder">
                                    <a href="product-details.html">
                                        <img src="{{assets('assets/img/products/prod-02.jpg')}}" alt="Product Image" class="primary-image">
                                    </a>
                                </div>
                                <span class="product-badge sale">sale</span>
                            </div>
    ...
    <!-- jQuery JS -->
    <script src="{{assets('assets/js/vendor.js')}}" ></script>
